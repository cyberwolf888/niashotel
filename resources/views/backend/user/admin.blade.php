            ...
            <div class="col s12 m12 l12">
                <div class="card">
                    <div class="card-content">
                        <span class="card-title">Kelola Admin</span>
                        <a class="waves-effect waves-light btn" href="{{ route('backend.user.admin.create') }}"><i class="material-icons left">open_in_new</i>Tambah Data Baru</a><br>
