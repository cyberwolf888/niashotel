            ...
            <div class="col s12 m12 l12">
                <div class="card">
                    <div class="card-content">
                        <span class="card-title">Kelola Karyawan</span>
                        <a class="waves-effect waves-light btn" href="{{ route('backend.user.karyawan.create') }}"><i class="material-icons left">open_in_new</i>Tambah Data Baru</a><br>
                        <table id="example" class="display responsive-table datatable-example">
                            ...
                            @foreach($model as $row)
                                <tr>
                                    ...
                                    <td>{{ $row->getStatus() }}</td>
                                    <td>
                                        <a href="{{ url(route('backend.user.karyawan.edit', ['id' => $row->id])) }}" class="btn-floating orange" style="opacity: 1;"><i class="material-icons">mode_edit</i></a>
                                    </td>
                                </tr>
                                <?php $no++; ?>
                            @endforeach
